          ...
          <Grid>
            <Grid.Column>
              ...
              <Segment attached="bottom" color="blue">
                ...
                Clicking &quot;Load Random User&quot; will update the store and
                at the same time the data is saved locally to{" "}
                <a
          ...
          <Grid>
            <Grid.Column>
              ...
              <Segment attached="bottom" color="orange">
                ...
                changes to the store but the saved data will still live in{" "}
                <a
                  href="https://developer.mozilla.org/en-US/docs/Web/API/Window/localStorage"
                  target="_blank"
                  rel="noreferrer"
